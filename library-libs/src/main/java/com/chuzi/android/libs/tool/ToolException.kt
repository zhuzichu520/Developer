...
import com.chuzi.android.libs.internal.MainHandler.post
import com.chuzi.android.libs.lambda.BiConsumer2
...
fun throwExceptionOnUIThread(msg: String?) {
    if (mIsDebugEnable) {
        ...
        post(Runnable { throw IllegalAccessError(if (msg.isNullOrEmpty()) "" else msg) })
    }
}
